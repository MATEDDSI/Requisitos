...
\input{Diag/Estadisticas.tex}

\newpage
\section{Operaciones de datos}

\subsection{Primer subsistema, consulta}
\input{Operaciones/Consulta.tex}

\subsection{Segundo subsistema, consejos}
\input{Operaciones/OperacionesConsejos.tex}

\subsection{ Tercer subsistema, inclusión}
\input{Navegabilidad/Inclusion.tex}

\subsection{Cuarto subsistema, estadísticas}
\input{Operaciones/Estadistica.tex}
...
\begin{itemize}
	\subsubsection{Iñaki}
\input{DependenciasFuncionales/inaki.tex}
\subsubsection{Bruno}
\input{DependenciasFuncionales/bruno.tex}
\subsubsection{Darío}
\input{DependenciasFuncionales/Dario.tex}
\subsubsection{Antonio}
\input{DependenciasFuncionales/antonio.tex}
\end{itemize}

\newpage
\subsection{Código de los triggers}
\subsection{Iñaki}
\lstinputlisting{Triggers/inaki.sql}
\subsection{Bruno}
\lstinputlisting{Triggers/bruno.sql}
\subsection{Darío}
\lstinputlisting{Triggers/dario.sql}
\subsection{Antonio}
\lstinputlisting{Triggers/antonio.sql}
